...
/**
 * \brief Converts timestamp to time of day (UTC timezone) and stores in a stringstream, accurate to nanosecond level
 * \param prefix String identifier printed alongside time of day
 * \param now time_point datatype generated by a system_clock
 * \param ik Integer identifier printed alongside time of day
 * \param ss Reference of stringstream that will store time of day information
*/
